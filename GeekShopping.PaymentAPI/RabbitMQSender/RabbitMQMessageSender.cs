    ...
    public class RabbitMQMessageSender : IRabbitMQMessageSender
    {
        ...
        public void SendMessage(BaseMessage message)
        {
            if (ConnectionExists()) // Verifica se tem conexão para abrir apenas uma vez
            {
                ...
                channel.QueueDeclare(PaymentEmailUpdateQueueName,false,false,false, arguments: null);
                channel.QueueDeclare(PaymentOrderUpdateQueueName, false, false, false, arguments: null);
